...
class Config:
    ...
    # Generated reports (Phase 4). Kept outside static/ on purpose — reports
    # can contain org-sensitive data, so they're served through a
    # permission-checked download route rather than being web-servable.
